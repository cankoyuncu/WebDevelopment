...
<body>
	...
	<div class="col-md-6 well">
		<h3 class="text-primary">TİCARET</h3>
		<hr style="border-top:1px dotted #ccc;"/>
		<!-- Link for redirecting page to Registration page -->
		<a href="index.php">Üye Ol</a>
		...
		<div class="col-md-6">
			...
			<form method="POST" action="login_query.php">	
				...
				?>
				<button class="btn btn-primary btn-block" name="login"><span class="glyphicon glyphicon-log-in"></span> Giriş Yap</button>
			</form>	
			<!-- Login Form Ends -->
		</div>
	</div>
